...
namespace SolrNet.Impl.ResponseParsers 
{
    ...
    public class ReplicationStatusResponseParser<T> : ReplicationAbstractResponseParser<T>, ISolrAbstractResponseParser<T>, ISolrReplicationStatusResponseParser
    {
        /// <summary>
        ...
        public ReplicationStatusResponse Parse(XDocument response)
        {
            ...
            var status = responseStatusNode != null ? responseStatusNode.Value : null;
            
            var responseMessageNode = response.XPathSelectElement("response/str[@name='message']");
            var message = responseMessageNode != null ? responseMessageNode.Value : null;
